        ...
        <div>
            ...
            <div className="overflow-x-auto my-14 w-11/12 mx-auto">
                <table className="table text-center">
                    ...
                    <tbody>
                        {
                            myReviews.length && myReviews.map((review, idx) =>
                                <tr key={review._id} className="hover">
                                    ...
                                    <td>
                                        <div className="flex flex-col justify-center items-center gap-1">
                                            <button className="outline-none rounded-full px-2 bg-yellow-400 text-black text-sm hover:scale-105"
                                            ...
                                            <button className="outline-none rounded-full px-2 bg-red-500 text-black text-sm hover:scale-105"
                                                    onClick={() => handleDeleteReview(review._id, review.title)}>
                                                        Delete
                                            </button>
                                        </div>
                                    </td>
                                    ...
                                    <dialog id={review._id} className="w-11/12 mx-auto max-h-[95vh] overflow-scroll">
                                        <div className="w-10/12 mx-auto my-8 border rounded-xl sm:p-8">
                                            <form id={`${review._id}a`} className="sm:space-y-8">
                                                ...
                                                <div className="grid sm:grid-cols-3 gap-4">
                                                    <div>
                                                        ...
                                                        <select name="genre" className="w-full h-12 rounded-lg px-4 border">
                                                    ...
                                                    <div>
                                                        ...
                                                        <select name="year" className="w-full h-12 rounded-lg px-4 border">
                                                    ...
                                                    <div>
                                                        ...
                                                        <select name="rating" className="w-full h-12 rounded-lg px-4 border">
                                            ...
                                            <button onClick={() => handleUpdateReview(review._id)} className="btn w-full h-12 rounded-lg border bg-green-500">Update Review</button>
